...
# @param manage_upstream_edition One of [ 'ce', 'ee', 'fips', 'disabled' ]. Manage the installation of an upstream Gitlab Omnibus edition to install.
...
class gitlab (
  ...
  Enum['ce', 'ee', 'fips', 'disabled'] $manage_upstream_edition         = 'ce',
